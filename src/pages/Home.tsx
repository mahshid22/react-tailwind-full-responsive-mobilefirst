  ...
  return (
    <div className="flex flex-col bg-[#F1F1F3] text-black">
      <div className="bg-[#F1F1F3]  h-[100%] flex flex-col items-center justify-center text-black p-3">
        ...
        <div className="flex flex-col mb-10">
          <div className="flex flex-col justify-start">
            <p className="font-bold text-3xl text-left">Our Testimonials</p>
            <p className="mb-5">
              Lorem ipsum dolor sit amet consectetur. Tempus tincidunt etiam
              eget elit id imperdiet et. Cras eu sit dignissim lorem nibh et. Ac
              cum eget habitasse in velit fringilla feugiat senectus in.
        ...
        <div className="flex flex-col mb-10">
          ...
          <div className="flex items-center justify-center bg-white w-[220px] p-3 self-center rounded-lg mb-10">
        ...
        <div className="bg-white w-full mb-5 rounded-xl p-7 flex flex-col">
          <div className="bg-[#F1F1F3] w-full  rounded-xl p-7 flex flex-col">
            ...
            <div className="bg-white w-full rounded-t-lg p-7 flex flex-col items-center">
        ...
        <div className="bg-white w-full mb-5 rounded-xl p-7 flex flex-col">
          <p className="font-bold text-3xl mb-2">Frequently Asked Questions</p>
          ...
          <div className="flex flex-col items-center rounded-xl border-2 border-[#F1F1F3] p-6 mb-5">
            ...
            <div className="flex flex-col">
              ...
              <div className="bg-[#F7F7F8] flex justify-between items-center py-3 px-5 rounded-md">
                <p className="pr-3">Enrollment Process for Different Courses</p>
      ...
      <div className="bg-white w-full mt-12 pt-12 px-5">
        ...
        <div className="flex text-black mb-6">
          <div className="mr-20 flex flex-col lg:min-w-[249px]">
