...
export default function Home() {
  return (
    <>
      {/* titre */}
      <div className="bg-white h-16 flex justify-center items-center rounded-lg max-md:w-full md:w-[643px]">
      ...
      <div className="flex flex-col mb-10 md:flex md:flex-row w-full md:justify-between md:items-center">
        <div className="flex flex-col justify-start md:max-w-[500px]">
          <p className="font-bold text-3xl text-left mb-3">Our Testimonials</p>
